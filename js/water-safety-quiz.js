// Simple Water Safety Quiz - Working Implementation
...
function initWaterSafetyQuiz() {
    ...
    console.log('Quiz initialized - found', questions.length, 'questions');

    // Add event listeners to all quiz options
    document.querySelectorAll('.quiz-option').forEach((option, index) => {
        console.log('Adding listener to option', index);
